...
insert into public.sponsor_search_terms (phrase, expands_to, category_hint, weight) values
  ...
  ('attic', array['home remodeling', 'whole home remodeling', 'home addition', 'construction', 'exterior remodeling', 'roofing', 'building materials'], 'Home Improvement', 2),
  ('attics', array['attic', 'home remodeling', 'whole home remodeling', 'home addition', 'construction', 'exterior remodeling', 'roofing', 'building materials'], 'Home Improvement', 2),
